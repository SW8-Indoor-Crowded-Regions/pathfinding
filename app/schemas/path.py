...
class FastestPathRequest(BaseModel):
    ...
    class ConfigDict:
        json_schema_extra = {
            "example": {
                "rooms": [
                    {"id": "room1", "name": "Lobby", "crowd_factor": 2, "occupants": 10, "area": 100},
                    {"id": "room2", "name": "Hallway", "crowd_factor": 1, "occupants": 5, "area": 50},
                    {"id": "room3", "name": "Meeting Room", "crowd_factor": 3, "occupants": 20, "area": 200}
                ],
                "sensors": [
